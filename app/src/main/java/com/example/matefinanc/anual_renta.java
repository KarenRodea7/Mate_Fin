...
public class anual_renta extends AppCompatActivity {
    EditText M, IT, N, P;
    TextView RENTA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anual_renta);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double cap = m/((1+(i/100)/p)*(Math.pow((1+(i/100)/p),((n/12)*p))-1)/((i/100)/p));
                RENTA.setText(""+cap);
